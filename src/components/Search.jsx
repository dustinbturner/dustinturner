  ...
  return (
    ...
    >
      <div
        id={`${id}-title`}
        aria-hidden="true"
        className="text-sm font-medium text-neutral-900 group-aria-selected:text-green-500 dark:text-white"
      >
    ...
    >
      ...
      >
        ...
        <div className="fixed inset-0 overflow-y-auto px-4 py-4 sm:px-6 sm:py-20 md:py-32 lg:px-8 lg:py-[15vh]">
          ...
          >
            <Dialog.Panel className="mx-auto transform-gpu overflow-hidden rounded-lg bg-neutral-50 shadow-xl ring-1 ring-neutral-900/7.5 sm:max-w-xl dark:bg-neutral-900 dark:ring-neutral-800">
