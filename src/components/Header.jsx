      ...
      <div className="flex items-center gap-5">
        <nav className="hidden md:block">
          <ul role="list" className="flex items-center gap-8">
            ...
            <TopLevelNavItem href="#">Projects</TopLevelNavItem>
            <TopLevelNavItem href="#">Writing</TopLevelNavItem>
          </ul>
        </nav>
        ...
        <div className="hidden min-[416px]:contents">
          <Button href="mailto:dustin@dustinbturner.com">Contact Me</Button>
        </div>
      </div>
    </motion.div>
  )
