...
function ProjectIcon({ icon: Icon }) {
  return (
    <div className="flex h-7 w-7 items-center justify-center rounded-full bg-neutral-900/5 ring-1 ring-neutral-900/25 backdrop-blur-[2px] transition duration-300 group-hover:bg-white/50 group-hover:ring-neutral-900/25 dark:bg-white/7.5 dark:ring-white/15 dark:group-hover:bg-green-300/10 dark:group-hover:ring-green-400">
      <Icon className="w-5 h-5 transition-colors duration-300 fill-neutral-700/10 stroke-neutral-700 group-hover:stroke-neutral-900 dark:fill-white/10 dark:stroke-neutral-400 dark:group-hover:fill-green-300/10 dark:group-hover:stroke-green-400" />
    </div>
  )
}

function ProjectPattern({ mouseX, mouseY, ...gridProps }) {
...
function Project({ project }) {
  ...
  return (
    ...
    >
      <ProjectPattern {...project.pattern} mouseX={mouseX} mouseY={mouseY} />
