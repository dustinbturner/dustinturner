    ...
    <Transition.Root show={isOpen} as={Fragment}>
      ...
      >
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 top-14 bg-neutral-400/20 backdrop-blur-sm dark:bg-black/40" />
        </Transition.Child>
        ...
        <Dialog.Panel>
          ...
          >
            <motion.div
              layoutScroll
              className="fixed bottom-0 left-0 top-14 w-full overflow-y-auto bg-white px-4 pb-4 pt-6 shadow-lg shadow-neutral-900/10 ring-1 ring-neutral-900/7.5 min-[416px]:max-w-sm sm:px-6 sm:pb-10 dark:bg-neutral-900 dark:ring-neutral-800"
            >
              <Navigation />
            </motion.div>
          </Transition.Child>
